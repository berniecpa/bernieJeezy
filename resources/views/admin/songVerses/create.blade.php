...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.songVerse.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.song-verses.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('song_verse') ? 'is-invalid' : '' }}" name="song_verse" id="song_verse">{{ old('song_verse') }}</textarea>
