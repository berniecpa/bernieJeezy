    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-songSummarySongSummaries">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($songSummaries as $key => $songSummary)
                            <tr data-entry-id="{{ $songSummary->id }}">
                                ...
                                <td>
                                    {{ $songSummary->song_summary->song_title ?? '' }}
                                </td>
                                <td>
...
@endcan
  ...
  let table = $('.datatable-songSummarySongSummaries:not(.ajaxTable)').DataTable({ buttons: dtButtons })
