...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.song.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.songs.update", [$song->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('song_title') ? 'is-invalid' : '' }}" type="text" name="song_title" id="song_title" value="{{ old('song_title', $song->song_title) }}">
