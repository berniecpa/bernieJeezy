...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.songSummary.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.song-summaries.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('song_summary') ? 'is-invalid' : '' }}" name="song_summary" id="song_summary">{{ old('song_summary') }}</textarea>
